...
• \`@${config.MM_BOT_USERNAME}\` — I'll auto-detect the topic
• \`@${config.MM_BOT_USERNAME} #topic-name\` — to specify the topic explicitly
• \`@${config.MM_BOT_USERNAME} help\` — show all commands`,
      });
    } catch (err) {
